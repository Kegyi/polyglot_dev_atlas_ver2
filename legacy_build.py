...
def load_mock_data():
    content_root = os.path.join(os.path.dirname(__file__), "legacy_content")
    ...
    if not pages:
        pages = [{"id": "p1", "group": "mem", "group_title": "System", "view": "Architecture", "title": "Welcome", "description": "No content found.", "insight": "Check legacy_content/pages/", "code_snippets": {}, "sub_contents": []}]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--watch', '-w', action='store_true', help='Watch legacy_content/ and rebuild on changes')
